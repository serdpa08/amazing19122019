...
function ask_about_product()
{
    ...
    <div id="contact-form" title="<?php _e("Solicitar presupuesto:", "product-enquiry-for-woocommerce");?>" style="display:none;">
    ...
    <label id="wdm_product_name" for='product_name'> <?php echo get_the_title();?> </label>
        ...
        _e("Teléfono", "product-enquiry-for-woocommerce");?>:</label>
        <input type="text" name="wdm_txtphone" id="wdm_txtphone" class="contact-input phone-field" value="" <?php echo $wdm_phone_required; ?>>
        </div>
        <?php }?>
        <!-- Subject Field -->
        <div class="wdm-pef-form-row">
        <label for='contact-subject'><?php _e("Asunto", "product-enquiry-for-woocommerce");?>:</label>
        <input type='text' id='contact-subject' class='contact-input' name='wdm_subject' value=''  />
        </div>
        <div class="wdm-pef-form-row">
        <label for='contact-message'>*<?php _e("Mensaje", "product-enquiry-for-woocommerce");?>:</label>
